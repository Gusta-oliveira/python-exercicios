...
if valor_p > sal_30:
    ...
    print('Pois as prestações ficaram em R${:.2f} passando 30% do salário!'.format(valor_p))
else:
    print('O empréstimo foi autorizado! Aproveite a aquisição!!')
    print('As prestações ficaram no valor de: R${:.2f}, pelo prazo de {}'.format(valor_p, anos))
